...
using com.logdb.docker.collector.ui.Security;
...
try
{
    ...
    builder.Services.AddDataProtection()
        ...
        .SetApplicationName("logdb-docker-collector-ui");
}
catch
{
...
var components = app.MapRazorComponents<com.logdb.docker.collector.ui.Layout.App>()
